...
def Reptilian(test,page):
	...
	for x in range(1,page):
		...
		#url = 'https://www.zhipin.com/c101280600/?query='+test+'&page=%s&ka=page-2'%x  #深圳
		url = 'https://www.zhipin.com/c101200100/?query='+test+'&page=%s&ka=page-2'%x  #武汉

		# print ('正在爬取第'+str(x)+'页：')+url
		print('url:',url)
