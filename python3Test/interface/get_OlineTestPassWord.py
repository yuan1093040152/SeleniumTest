...
if __name__ == '__main__':
    ...
    ids = [{'06045224': '袁猛'}, {'00410622': '冉成浩'},{'00454949': '曾亮'}, {'77850920': '李宗荣'}, {'00417286': '丁凯'}, {'00401515': '甘婷'}, {'02070281': '曹燕'}, {'77850125': '林美玲'},  {'02081317': '王曼莹'}, {'06058331': '刘颖'},{'00465762': '王韶雪'},{'02017413': '张秀云'}]
    # ids = [{'06045224': '袁猛'}]
    print(ids)
    text = rs_time
    title = 'UAT验收环境登陆密码'
